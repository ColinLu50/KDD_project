...
class gcn_estimator(torch.nn.Module):
    def __init__(self, config, gcn_dataset):
        ...
        self.graph = gcn_dataset.getSparseGraph()
        self.state_idx2uid = gcn_dataset.state_idx2uid

    def forward(self, x, u_idx, state, training = True):
        ...
        u_id = self.state_idx2uid[state][u_idx]
