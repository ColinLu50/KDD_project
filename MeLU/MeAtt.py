...
class attention_estimator(torch.nn.Module):
    ...
    def forward(self, x, training = True):
        ...
        user_attention = F.softmax(self.fc2(layer1_act) / (self.embedding_dim * 4) ** (1/2), dim=1)
        item_attention = F.softmax(self.fc3(layer1_act) / (self.embedding_dim * 4) ** (1/2), dim=1)
