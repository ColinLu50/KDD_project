...
if __name__ == "__main__":
    ...
    training(megcn, total_dataset, batch_size=1, num_epoch=config['num_epoch'], model_save=True, model_filename=model_filename)

    evaluation_(megcn, master_path, 'megcn_1_simple')