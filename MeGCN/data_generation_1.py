...
def item_converting(row, rate_list, genre_list, director_list, actor_list):
    ...
    rate_feature = torch.zeros(1, config['num_rate']).long()
    ...
    return (rate_feature, genre_idx, director_idx, actor_idx)
